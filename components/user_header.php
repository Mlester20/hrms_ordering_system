      ...
      <div class="flex items-center space-x-6">
        ...
        <div class="relative group">
          ...
          <div class="absolute right-0 mt-2 w-48 rounded-lg shadow-2xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50" style="background-color: var(--bg-card); border: 1px solid var(--accent-cyan);">
            ...
            <a href="/profile" class="block px-4 py-2 text-sm transition duration-150 flex items-center space-x-2" style="color: var(--text-primary);" onmouseover="this.style.backgroundColor='var(--bg-secondary)'; this.style.color='var(--accent-cyan)'" onmouseout="this.style.backgroundColor='transparent'; this.style.color='var(--text-primary)'">
              <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
              </svg>
              <span>My Profile</span>
            </a>
            <a href="/addresses" class="block px-4 py-2 text-sm transition duration-150 flex items-center space-x-2" style="color: var(--text-primary);" onmouseover="this.style.backgroundColor='var(--bg-secondary)'; this.style.color='var(--accent-cyan)'" onmouseout="this.style.backgroundColor='transparent'; this.style.color='var(--text-primary)'">
              <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="/favorites" class="block px-4 py-2 text-sm transition duration-150 flex items-center space-x-2" style="color: var(--text-primary);" onmouseover="this.style.backgroundColor='var(--bg-secondary)'; this.style.color='var(--accent-cyan)'" onmouseout="this.style.backgroundColor='transparent'; this.style.color='var(--text-primary)'">
              <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
              </svg>
              <span>Favorites</span>
            </a>
            <a href="/orders-history" class="block px-4 py-2 text-sm transition duration-150 flex items-center space-x-2" style="color: var(--text-primary);" onmouseover="this.style.backgroundColor='var(--bg-secondary)'; this.style.color='var(--accent-cyan)'" onmouseout="this.style.backgroundColor='transparent'; this.style.color='var(--text-primary)'">
              <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="/settings" class="block px-4 py-2 text-sm transition duration-150 flex items-center space-x-2" style="color: var(--text-primary);" onmouseover="this.style.backgroundColor='var(--bg-secondary)'; this.style.color='var(--accent-cyan)'" onmouseout="this.style.backgroundColor='transparent'; this.style.color='var(--text-primary)'">
              <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
